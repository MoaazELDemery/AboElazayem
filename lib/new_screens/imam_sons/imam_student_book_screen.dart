...
class ImamStudentBookScreen extends StatefulWidget {
  final String pdfUrl;
  final String title;

  ImamStudentBookScreen({required this.pdfUrl, required this.title});

  @override
  _ImamStudentBookScreenState createState() => _ImamStudentBookScreenState();
}

class _ImamStudentBookScreenState extends State<ImamStudentBookScreen> {
