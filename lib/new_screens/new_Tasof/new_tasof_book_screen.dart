...
class NewTasofBookScreen extends StatefulWidget {
  final String title;
  final String pdfUrl;

  const NewTasofBookScreen({required this.title, required this.pdfUrl});
  @override
  _NewTasofBookScreenState createState() => _NewTasofBookScreenState();
}

class _NewTasofBookScreenState extends State<NewTasofBookScreen> {
