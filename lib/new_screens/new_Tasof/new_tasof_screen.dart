...
import 'new_tasof_category_screen.dart';

class NewTasofScreen extends StatelessWidget {
      ...
      child: Scaffold(
        body: SafeArea(
          ...
          Container(
            ...
            child: FutureBuilder(
              future: ServicesV2().getTasofHomeData(),
              builder: (context, AsyncSnapshot snapshot) {
                ...
                List aboutTextData = snapshot.data[0];
                return ListView.builder(
                  shrinkWrap: true,
                  itemCount: aboutTextData.length,
                        ...
                        Container(
                          ...
                          child: Text(
                            translator.currentLanguage == 'ar'
                                ? aboutTextData[index].name_ar
                                : aboutTextData[index].name_en,
                            style: TextStyle(
                                color: Color(0xff444444),
                                fontSize: 19,
                                fontWeight: FontWeight.bold),
                        ...
                        Container(
                          child: Html(
                            data: translator.currentLanguage == 'ar'
                                ? aboutTextData[index].description_ar
                                : aboutTextData[index].description_en,
                          ),
                        ),
                        SizedBox(
                    ...
                    child: Padding(
                        ...
                        child: FutureBuilder(
                          ...
                          builder: (context, AsyncSnapshot snapshot) {
                            ...
                            List aboutLibrarytData = snapshot.data[1];
                            return GridView.count(
                              crossAxisCount: 2,
                              mainAxisSpacing: 10,
                              crossAxisSpacing: 10,
                              scrollDirection: Axis.vertical,
                              children: List.generate(aboutLibrarytData.length,
                                  (index) {
                                return InkWell(
                                    ...
                                    Provider.of<MainProvider>(context,
                                      ...
                                      if (value == true) {
                                        Navigator.push(
                                            context,
                                            TransitionPageRoute(
                                                widget: NewTasofCategoryScreen(
                                                    id: aboutLibrarytData[index]
                                                        .id)));
                                      }
                                    });
                                  },
                                  child: Container(
                                    ...
                                    child: Text(
                                      translator.currentLanguage == 'ar'
                                          ? aboutLibrarytData[index].name_ar
                                          : aboutLibrarytData[index].name_en,
                                      style: TextStyle(
                                          fontSize: 13,
                                          fontWeight: FontWeight.bold),
                                    ),
