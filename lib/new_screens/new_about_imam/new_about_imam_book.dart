...
class NewAboutImamBook extends StatefulWidget {
  final String title;
  final String pdfUrl;

  const NewAboutImamBook({required this.title, required this.pdfUrl});
  @override
  _NewAboutImamBookState createState() => _NewAboutImamBookState();
}

class _NewAboutImamBookState extends State<NewAboutImamBook> {
