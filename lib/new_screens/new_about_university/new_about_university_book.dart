...
class NewAboutUniversityBook extends StatefulWidget {
  final String title;
  final String pdfUrl;

  const NewAboutUniversityBook({required this.title, required this.pdfUrl});

  @override
  _NewAboutUniversityBookState createState() => _NewAboutUniversityBookState();
}

class _NewAboutUniversityBookState extends State<NewAboutUniversityBook> {
