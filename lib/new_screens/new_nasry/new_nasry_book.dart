...
class NewNasryBook extends StatefulWidget {
  final String pdfUrl;

  NewNasryBook({required this.pdfUrl});
  @override
  _NewNasryBookState createState() => _NewNasryBookState();
}

class _NewNasryBookState extends State<NewNasryBook> {
