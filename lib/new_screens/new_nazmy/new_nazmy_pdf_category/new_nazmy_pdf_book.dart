...
class NewNazmyPdfBook extends StatefulWidget {
  final String pdfUrl;

  NewNazmyPdfBook({required this.pdfUrl});
  @override
  _NewNazmyPdfBookState createState() => _NewNazmyPdfBookState();
}

class _NewNazmyPdfBookState extends State<NewNazmyPdfBook> {
