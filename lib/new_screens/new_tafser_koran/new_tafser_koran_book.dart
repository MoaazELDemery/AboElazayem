...
class NewTafserKoranBook extends StatefulWidget {
  final String pdfUrl;

  const NewTafserKoranBook({required this.pdfUrl});
  @override
  _NewTafserKoranBookState createState() => _NewTafserKoranBookState();
}

class _NewTafserKoranBookState extends State<NewTafserKoranBook> {
