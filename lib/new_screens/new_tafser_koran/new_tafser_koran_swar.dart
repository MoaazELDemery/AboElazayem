import 'package:com.app.aboelazayem/new_screens/new_tafser_koran/new_tafser_koran_book.dart';
...
class NewTafserKoranSwar extends StatelessWidget {
  final List swarData;
  NewTafserKoranSwar(this.swarData);
                  ...
                  child: Scrollbar(
                    child: Padding(
                      ...
                      child: GridView.count(
                        ...
                        children: List.generate(swarData.length, (index) {
                          return InkWell(
                              ...
                              Provider.of<MainProvider>(context, listen: false)
                                ...
                                if (value == true) {
                                  Navigator.push(
                                      context,
                                      TransitionPageRoute(
                                          widget: NewTafserKoranBook(
                                        pdfUrl: swarData[index].pdf_path,
                                      )));
                                }
                              });
                            },
